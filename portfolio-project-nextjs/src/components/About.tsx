  ...
  return (
    <div className="max-w-[1200px] mx-auto" id="about">
      <h1 className="text-white text-6xl max-w-[320px] mx-auto font-semibold p-4 mb-4">
        About <span className="text-orant-400">Me</span>
      </h1>
      ...
      <div className="px-6 md:p-0 grid md:grid-cols-8 gap-6 place-items-center">
        ...
        <div className="w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              <h2 className="text-2-xl font-bold text-white/80">Education</h2>
        ...
        <div className="w-full md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              <h2 className="text-2-xl font-bold text-white/80">
                Problem Solving
              </h2>
              <p className="text-lg text-white/70">xxxx</p>
            </div>
        ...
        <div className="w-full md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              <h2 className="text-2-xl font-bold text-white/80">Experience</h2>
              <p className="text-lg text-white/70">xxxx</p>
            </div>
          </div>
        </div>
